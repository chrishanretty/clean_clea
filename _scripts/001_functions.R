...
# Compute bounds on wasted votes ------------------------------------------

# nv2: Effective number of vote-winning parties
# nv0:  Actual number of vote-winning parties
# ns0:  Actual number of seat-winning parties

w_min <-
  function(nv2, nv0, ns0){
