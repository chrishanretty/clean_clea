### Norway (September 1965)

### Data from https://en.wikipedia.org/wiki/1965_Norwegian_parliamentary_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Norway 1965")
}
