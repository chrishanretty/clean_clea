### Finland (September 1975)

### Data from https://en.wikipedia.org/wiki/1975_Finnish_parliamentary_election
...
### SKYP (Suomen Kansan Yhtenaisyyden Puolue / Finnish People's Unity Party)
### SPK (Suomen Perustuslaillinen Kansanpuolue / Finnish Constitutional People's Party)
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Finland 1975")
}
...
parties <- c("SDP", "SKDL", "Kesk", "Kok", "RKP", "LKP", "SKL", "SMP", "SKYP", "SPK", "ÅS")
patch <- patch |>
