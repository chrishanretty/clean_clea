### Portugal (October 1985)

### Data from https://en.wikipedia.org/wiki/1985_Portuguese_legislative_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Portugal 1985")
}
