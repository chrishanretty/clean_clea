...
### Data from https://en.wikipedia.org/wiki/1951_Finnish_parliamentary_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Finland 1951")
}
...
parties <- c("SDP", "ML", "SKDL", "Kok", "RKP", "SK", "ÅS")
patch <- patch |>
