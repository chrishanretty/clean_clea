### Norway (September 1969)

### Data from https://en.wikipedia.org/wiki/1969_Norwegian_parliamentary_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Norway 1969")
}
