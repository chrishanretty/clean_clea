...
### Data from https://en.wikipedia.org/wiki/1924_Norwegian_parliamentary_election
...
### V / Venstre (25)
### B / Bondepartiet (3)
### Sd / Norges Socialdemokratiske Arbeiderparti (16)
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Norway 1924")
}
