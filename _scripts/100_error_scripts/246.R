...
### Data from https://en.wikipedia.org/wiki/1929_Finnish_parliamentary_election
...
### SKP / the communist front list (Sosialistinen työväen ja
###   pienviljelijäin puolue, 13)
...
if (anyDuplicated(patch_mags[, c("cst_n")])) {
    stop("Duplicate entries in patches for Finland 1929")
}
...
if (any(is.na(patch$pty))) {
    stop("Unmapped party in patches for Finland 1929")
}
