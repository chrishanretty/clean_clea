### Norway (September 1961)

### Data from https://en.wikipedia.org/wiki/1961_Norwegian_parliamentary_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Norway 1961")
}
