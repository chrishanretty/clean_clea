...
### Data from https://en.wikipedia.org/wiki/1973_Norwegian_parliamentary_election
...
### SV / Socialistisk Valgallianse (5006)
### ALp / Anders Langes Parti (1)
### V / Venstre (25)
### DNF / Det Nye Folkeparti (6)
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Norway 1973")
}
...
parties <- c("Ap", "H", "Sp", "KrF", "SV", "ALp", "V", "DNF")
