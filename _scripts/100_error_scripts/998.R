...
### Data from https://en.wikipedia.org/wiki/2002_Portuguese_legislative_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Portugal 2002")
}
