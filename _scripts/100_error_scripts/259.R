### Finland (January 1972)

### Data from https://en.wikipedia.org/wiki/1972_Finnish_parliamentary_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Finland 1972")
}
...
parties <- c("SDP", "SKDL", "Kesk", "Kok", "SMP", "RKP", "LKP", "SKL", "ÅS")
patch <- patch |>
