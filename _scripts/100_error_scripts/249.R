...
### Data from https://en.wikipedia.org/wiki/1936_Finnish_parliamentary_election
...
if (anyDuplicated(patch_mags[, c("cst_n")])) {
    stop("Duplicate entries in patches for Finland 1936")
}
...
if (any(is.na(patch$pty))) {
    stop("Unmapped party in patches for Finland 1936")
}
