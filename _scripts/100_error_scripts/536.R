...
### Data from https://en.wikipedia.org/wiki/1936_Norwegian_parliamentary_election
...
### V / Venstre (25)
### B / Bondepartiet (3)
### SfP / Samfundspartiet (20)
###
### The data file also records two seats for Kristelig Folkeparti (KrF) in
### Hordaland. CLEA has no party code for KrF in 1936, so these seats cannot
### be patched onto an existing row and are omitted here. (The patch template
### only updates existing CLEA rows; it does not add new ones.)
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Norway 1936")
}
