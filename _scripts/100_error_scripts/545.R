### Norway (September 1977)

### Data from https://en.wikipedia.org/wiki/1977_Norwegian_parliamentary_election
...
if (anyDuplicated(patch_mags[, c("cst")])) {
    stop("Duplicate entries in patches for Norway 1977")
}
