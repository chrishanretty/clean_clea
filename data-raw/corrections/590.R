# Sweden (September, 1948)

# Data from:
#
# Svenska Dagbladets Årsbok / Tjugosjätte årgången (händelserna 1948)
# https://runeberg.org/svda/1948/0078.html

patch <- readr::read_csv(
  file.path(data_raw_dir, "manual", "swe_1948.csv"),
