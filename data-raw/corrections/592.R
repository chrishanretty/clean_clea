# Sweden (September, 1956)

# Data from:
#
# Svenska Dagbladets Årsbok / Trettiofjärde årgången (händelserna 1956)
# https://runeberg.org/svda/1956/0088.html

patch <- readr::read_csv(
  file.path(data_raw_dir, "manual", "swe_1956.csv"),
