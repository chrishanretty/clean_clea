...
# Data from Tab R., p. 48 of https://share.scb.se/ov9993/data/historisk%20statistik/SOS%201911-%2FValstatistiken%2FRiksdagsmannavalen%20(SOS)%201909-1968%2FValstatistik-Riksdagsmannavalen-1922-1923-1924.pdf

patch <- readr::read_csv(
  file.path(data_raw_dir, "manual", "swe_1924.csv"),
...
## Social Democrats
## Communists
## Vildar (independents), listed separately but part of the Free-minded national association for most.
